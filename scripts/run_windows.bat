...
CALL :print_highlight "Installing Docugraph"
...
CALL :print_highlight "Launching Docugraph in your browser, please wait..."
CALL :launch_ui
...
pip list | findstr /C:"docugraph" >NUL 2>&1
IF %ERRORLEVEL% == 0  (
    ...
    IF EXIST "pyproject.toml" (
        ...
        ECHO Installing libs\docugraph
        python -m pip install -e "%CD%\libs\docugraph"
...
ECHO Starting Docugraph UI... (prebuilt PDF.js is at %PDFJS_PREBUILT_DIR%)
