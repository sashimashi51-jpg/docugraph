...
KH_WEB_SEARCH_BACKEND = (
    "docugraph.indices.retrievers.tavily_web_search.WebSearch"
    # "docugraph.indices.retrievers.jina_web_search.WebSearch"
)

KH_DOCSTORE = {
    # "__type__": "docugraph.storages.ElasticsearchDocumentStore",
    # "__type__": "docugraph.storages.SimpleFileDocumentStore",
    "__type__": "docugraph.storages.LanceDBDocumentStore",
    "path": str(KH_USER_DATA_DIR / "docstore"),
}
KH_VECTORSTORE = {
    # "__type__": "docugraph.storages.LanceDBVectorStore",
    "__type__": "docugraph.storages.ChromaVectorStore",
    # "__type__": "docugraph.storages.MilvusVectorStore",
    # "__type__": "docugraph.storages.QdrantVectorStore",
...
if config("AZURE_OPENAI_API_KEY", default="") and config(
    ...
    if config("AZURE_OPENAI_CHAT_DEPLOYMENT", default=""):
        KH_LLMS["azure"] = {
            "spec": {
                "__type__": "docugraph.llms.AzureChatOpenAI",
                "temperature": 0,
    ...
    if config("AZURE_OPENAI_EMBEDDINGS_DEPLOYMENT", default=""):
        KH_EMBEDDINGS["azure"] = {
            "spec": {
                "__type__": "docugraph.embeddings.AzureOpenAIEmbeddings",
                "azure_endpoint": config("AZURE_OPENAI_ENDPOINT", default=""),
                "api_key": config("AZURE_OPENAI_API_KEY", default=""),
                "api_version": config("OPENAI_API_VERSION", default="")
                or "2024-02-15-preview",
...
if OPENAI_API_KEY:
    KH_LLMS["openai"] = {
        "spec": {
            "__type__": "docugraph.llms.ChatOpenAI",
            "temperature": 0,
    ...
    KH_EMBEDDINGS["openai"] = {
        "spec": {
            "__type__": "docugraph.embeddings.OpenAIEmbeddings",
...
if VOYAGE_API_KEY:
    KH_EMBEDDINGS["voyageai"] = {
        "spec": {
            "__type__": "docugraph.embeddings.VoyageAIEmbeddings",
    ...
    KH_RERANKINGS["voyageai"] = {
        "spec": {
            "__type__": "docugraph.rerankings.VoyageAIReranking",
            "model_name": "rerank-2",
            "api_key": VOYAGE_API_KEY,
        },
        "default": False,
...
if config("LOCAL_MODEL", default=""):
    ...
    KH_LLMS["ollama-long-context"] = {
        "spec": {
            "__type__": "docugraph.llms.LCOllamaChat",
    ...
    KH_EMBEDDINGS["fast_embed"] = {
        "spec": {
            "__type__": "docugraph.embeddings.FastEmbedEmbeddings",
...
KH_LLMS["claude"] = {
    "spec": {
        "__type__": "docugraph.llms.chats.LCAnthropicChat",
...
KH_LLMS["google"] = {
    "spec": {
        "__type__": "docugraph.llms.chats.LCGeminiChat",
...
KH_LLMS["cohere"] = {
    "spec": {
        "__type__": "docugraph.llms.chats.LCCohereChat",
...
KH_EMBEDDINGS["cohere"] = {
    "spec": {
        "__type__": "docugraph.embeddings.LCCohereEmbeddings",
...
KH_EMBEDDINGS["google"] = {
    "spec": {
        "__type__": "docugraph.embeddings.LCGoogleEmbeddings",
...
KH_EMBEDDINGS["mistral"] = {
    "spec": {
        "__type__": "docugraph.embeddings.LCMistralEmbeddings",
        "model": "mistral-embed",
        "api_key": config("MISTRAL_API_KEY", default="your-key"),
    },
    "default": False,
...
#     "spec": {
#         "__type__": "docugraph.embeddings.LCHuggingFaceEmbeddings",
...
KH_RERANKINGS["cohere"] = {
    "spec": {
        "__type__": "docugraph.rerankings.CohereReranking",
