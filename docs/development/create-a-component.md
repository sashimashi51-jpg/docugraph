...
A fundamental concept in docugraph is "component".
...
and a component! Because of that, in docugraph, we will consider them the
same as "component".

To define a component, you will:

1. Create a class that subclasses from `docugraph.base.BaseComponent`
...
```python
from docugraph.base import BaseComponent
from docugraph.llms import LCAzureChatOpenAI
from docugraph.parsers import RegexExtractor
