...
effective. To facilitate this, `docugraph` offers a user-friendly prompt engineering UI
...
2. [tech] Export pipeline to config: `$ docugraph promptui export <module.path.piplineclass> --output <path/to/config/file.yml>`
3. [tech] Customize the config
4. [tech] Spin up prompt engineering UI: `$ docugraph promptui run <path/to/config/file.yml>`
...
```shell
$ docugraph promptui export <module.path.piplineclass> --output <path/to/config/file.yml>
```
...
```shell
$ docugraph promptui run <path/to/config/file.yml>
```
