...
In essence, a pipeline will subclass from `docugraph.base.BaseComponent`.
...
```python
    def run(self, question: str, history: list, **kwargs) -> Document:
        ...
        Returns:
            docugraph.base.Document: the final answer
        """
```
...
[one](https://github.com/Cinnamon/docugraph/blob/main/flowsettings.py).
