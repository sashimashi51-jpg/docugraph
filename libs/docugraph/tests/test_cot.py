...
from docugraph.llms import AzureChatOpenAI
from docugraph.llms.cot import ManualSequentialChainOfThought, Thought
...
_openai_chat_completion_response = [
    ...
    for text in ["Bonjour", "ã“ã‚“ã«ã¡ã¯ (Konnichiwa)"]
]
