"""Tests for docugraph.agents.tools.mcp module.
...
from docugraph.agents.tools.mcp import (
    MCPTool,
...
# ---------------------------------------------------------------------------
# _json_schema_type_to_python â€” parametrized to avoid 7 near-identical tests
# ---------------------------------------------------------------------------
...
class TestMakeTool:
    ...
    def test_missing_schema_and_description_uses_defaults(self):
        """No inputSchema â†’ args_schema is None; None description â†’ auto-generated."""
...
class TestFormatToolList:
    ...
    def test_partial_filter_shows_counts_and_icons(self):
        ...
        assert "âœ…" in result  # fetch enabled
        assert "â¬œ" in result  # search disabled
...
class TestCreateToolsFromConfig:
    ...
    @patch("docugraph.agents.tools.mcp._run_async")
